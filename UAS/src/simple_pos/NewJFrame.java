...
/**
 *
 * @author I Gusti Ngurah Agus Ega Patria Pramudita
 * 2201010365
 */
 ...
 public void addtable(int id, String name, int qty, double price) {
    ...
    public void cal() {
        ...
        for (int i = 0; i < numOfRow; i++) {
            try {
                Number number = format.parse(jTable1.getValueAt(i, 3).toString());
   ...
   public void Bill() {
        ...
        try {
           ...
           b.setText("              PEMOEDA KALEM OFFICIAL STORE \n");
            b.setText(b.getText() + "           14/ Tukad Yeh Aya, Panjer, Denpasar Selatan\n");
            b.setText(b.getText() + "                         Denpasar, Bali, Indonesia, \n");
            b.setText(b.getText() + "                              +6287826278909, \n");
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
            b.setText(b.getText() + "                         Thanks For Shopping!"+"\n");
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
    ...
    public void pay() {
        ...
        // Check if payText is not empty
        if (payText == null || payText.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter valid numeric values for Pay", "Input Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            // Ensure that payText is a valid number
    ...
    private void initComponents() {
        ...
        setTitle(" PEMOEDA KALEM OFFICIAL STORE ");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        addtables(4, "SPIDERWAN", i, 60.000);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        addtables(5, "8 NAN POOL", i, 60.000);
